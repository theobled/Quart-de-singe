...
struct Partie {
  char mot[MAX_LENMOT]; // le mot de la manche
  unsigned int taillemot; // la taille du mot de la manche
  unsigned int nbJoueurs; // le nombre de joueurs de la partie
  unsigned int dernierJoueurPerdant; // le derniere joueur qui a ecope un quart de singe
  BOOL nouveauTour;
  char motJoueurDeviner[MAX_LENMOT]; // mot a deviner
